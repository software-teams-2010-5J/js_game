...
msglabel[2] = new Label();
msglabel[2].font = "32px monospace";
msglabel[2].color = "#000000";
msglabel[2].text = "Owner :";
msglabel[2].x = MESSAGE_WINDOW_POSITION_X + MESSAGE_MARGIN_X;
msglabel[2].y = MESSAGE_WINDOW_POSITION_Y + MESSAGE_MARGIN_Y;